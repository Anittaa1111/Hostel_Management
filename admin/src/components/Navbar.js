  ...
  return (
    <nav className="navbar">
      <div className="navbar-container">
        ...
        {location.pathname === '/dashboard' && onNavigate && (
          <div className="navbar-menu">
            <button onClick={() => onNavigate('overview')} className="nav-btn">
            ...
            <button onClick={() => onNavigate('students')} className="nav-btn">
              <svg width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
